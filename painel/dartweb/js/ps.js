/**
	 ...
	 * ReEdited by: Douglas A. de Oliveira
     * Last Modified: 29/05/2013
     */
    (function(a) {
        a.extend(a.fn, {pstrength:function(b) {
            var b = a.extend({verdects:["Muito fraca","Fraca","Média","Forte","Muito forte"],colors:["#F00","#C06","#F60","#3C0","#3D0"],scores:[10,15,30,40],common:["password","123456","123","senha","blink182","654321","qwerty","monkey","abc123","letmein","iloveyou","000000","1111111"],minchar:5}, b);
