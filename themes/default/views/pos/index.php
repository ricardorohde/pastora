										...
										<div id="lefttop" style="margin-bottom:5px;">
											<div class="form-group" style="margin-bottom:5px;">
												<div class="input-group">
													<?php foreach($customers as $customer){ $cus[$customer->id] = $customer->name.' | '.$customer->phone.' | '.$customer->cf2.' | '.$customer->endereco.' '.$customer->numero.' '.$customer->bairro; } ?>
					...
					<div class="col-xs-9">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-group">
									<?= lang('note', 'note'); ?>
<textarea  name="note"  id="note" class="pa form-control kb-text" style=" height:140px;"></textarea>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
