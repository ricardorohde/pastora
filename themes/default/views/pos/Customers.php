...
class Customers extends MY_Controller
{
    ...
    function get_customers()
    {
    	...
    	$this->datatables
    	->select("id, name, phone, phone2, email, cf1, cf2, datanscimento, endereco, numero, complemento, bairro, cep, cidade, estado, obs1")
    	->from("customers")
	...
	function add()
	{
		...
		if ($this->form_validation->run() == true) {
			...
			$data = array('name' => $this->input->post('name'),
				...
				'datanscimento' => $this->input->post('datanscimento'),
