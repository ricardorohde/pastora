    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            if ($payments) {
				...
				echo '<b>Dados para Entrega:</b> <br />';
				echo $customer->endereco.', nº'.$customer->numero.' '.$customer->complemento.'<br />'.$customer->cep.' - '.$customer->bairro.' - '.$customer->cidade.'/'.$customer->estado;
				echo '<br />'.$customer->name;
				echo ' '.$customer->phone.' / '.$customer->cf2;
            }
